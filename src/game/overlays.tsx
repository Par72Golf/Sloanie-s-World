...
function HUD() {
  ...
  const creatureNear = useGame((s) => s.creatureNear);
  const basketNear = useGame((s) => s.basketNear);
  const shopNear = useGame((s) => s.shopNear);
